from flask import render_template, redirect, request, url_for, flash, current_app, return jsonify({'message': 'Trainer not found!'}), 401
from . import main
...
@main.route('/activate_user/<str:end_date>/<int:id>', methods=['POST'])
@login_required
